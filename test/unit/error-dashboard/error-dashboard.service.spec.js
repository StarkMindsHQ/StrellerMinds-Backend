...
describe('ErrorDashboardService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(ErrorDashboardService);
    ...
    describe('addErrorLog', () => {
        it('should create and save an error log', async () => {
            ...
            jest.spyOn(errorLogRepository, 'create').mockReturnValue(mockErrorLogEntity);
            jest.spyOn(errorLogRepository, 'save').mockResolvedValue(mockErrorLogEntity);
        ...
        it('should log error if saving fails', async () => {
            ...
            jest.spyOn(errorLogRepository, 'create').mockReturnValue(mockErrorLog);
    ...
    describe('getErrorSummary', () => {
        it('should return error summary', async () => {
            ...
            jest.spyOn(errorLogRepository, 'createQueryBuilder').mockReturnValue(queryBuilderMock);
