...
export class I18nController {
  ...
  async setUserLocale(
    ...
    @Body() dto: { locale: string; preferences?: any },
  ) {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  async syncWithTms(@Body() dto: { locale: string; namespace?: string }) {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  async invalidateCache(@Body() dto: { locale?: string; namespace?: string }) {
