...
export class ContentRecommendationService {
  constructor(private patternService: LearningPatternAnalysisService) {}
  ...
  private generateMockRecommendations(patternType: string, limit: number) {
    const baseRecommendations = [
      {
        ...
        score: 0.95,
        reason: 'Based on your interest in Smart Contracts',
      },
      {
        id: 'c-102',
      ...
      },
      {
        ...
        score: 0.82,
        reason: 'Highly rated by similar learners',
      },
    ];
    ...
    if (patternType === 'struggling') {
      return [
        {
          id: 'c-001',
          title: 'Blockchain Fundamentals Refresher',
          score: 0.99,
          reason: 'Recommended to strengthen foundations',
        },
    ...
    if (patternType === 'high_performer') {
      return [
        {
          id: 'c-201',
          title: 'Mastering EVM OpCodes',
          score: 0.98,
          reason: 'Challenge content for high performers',
        },
        ...baseRecommendations.slice(0, limit - 1),
      ];
    }
