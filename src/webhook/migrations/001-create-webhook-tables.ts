...
export class CreateWebhookTables1703001000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'webhook_deliveries',
      new Index('IDX_webhook_deliveries_status', ['status']),
    );
    await queryRunner.createIndex(
      'webhook_deliveries',
      new Index('IDX_webhook_deliveries_created_at', ['createdAt']),
    );
    await queryRunner.createIndex(
      'webhook_deliveries',
      new Index('IDX_webhook_deliveries_webhook_id', ['webhookId']),
    );
  }
