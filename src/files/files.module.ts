...
import { ChunkUploadCleanupScheduler } from './schedulers/chunk-upload-cleanup.scheduler';
...
@Module({
  ...
  providers: [
    ...
    ChunkUploadCleanupScheduler,
    {
      provide: 'StorageProvider',
      useClass: S3StorageService,
    },
  ],
  exports: [FilesService, 'StorageProvider', ChunkUploadService, FileCompressionService, CDNIntegrationService],
})
