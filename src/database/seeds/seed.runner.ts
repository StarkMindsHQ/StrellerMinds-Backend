...
export class SeedRunner {
    ...
    private async seedMinimal(queryRunner: any): Promise<void> {
        ...
        const instructors = await this.createUsers(queryRunner, await UserFactory.generateInstructors(2));
    ...
    private async seedStandard(queryRunner: any): Promise<void> {
        ...
        const admin = await this.createUser(queryRunner, await UserFactory.generateAdmin());
        const instructors = await this.createUsers(queryRunner, await UserFactory.generateInstructors(5));
    ...
    private async seedFull(queryRunner: any): Promise<void> {
        ...
        const admin = await this.createUser(queryRunner, await UserFactory.generateAdmin());
        const instructors = await this.createUsers(queryRunner, await UserFactory.generateInstructors(10));
     ...
     * Create courses
     */
    private async createCourses(queryRunner: any, instructors: User[], count: number): Promise<Course[]> {
        const coursesData = [];
